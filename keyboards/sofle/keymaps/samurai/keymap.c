...
[0] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LCTRL,KC_LALT,KC_LGUI, MO(2), KC_ENT,            KC_SPC,  MO(3), KC_RGUI, KC_RALT, KC_RCTRL
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 */
[3] = LAYOUT(
  _______, _______ , _______ , _______ , _______ , _______,                           RGB_SAI,  RGB_TOG  , RGB_MOD,  RGB_HUI ,  RGB_HUD ,_______,
