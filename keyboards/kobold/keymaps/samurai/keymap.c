...
[1] = LAYOUT(
  ...
  KC_GRV,  UC_NEXT,    _______, _______, _______, _______,                        _______,  UC(0x00FC), _______, UC(0x00F6), _______, KC_F12,
  _______, UC(0x00E4), KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                        KC_CIRC,  KC_AMPR,    KC_LPRN, KC_RPRN,    KC_ASTR, KC_PIPE,
  _______, KC_EQL,     KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,      _______, _______,  KC_GRV,     KC_LBRC, KC_RBRC,    KC_BSLS, KC_BSLS,
                       _______, _______, _______, _______, _______,      _______, _______, _______,     _______, _______
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    | ValU |      |ModNxt|      | SpdU | OnOff|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    | ValD | PagD |  Up  | HueD | SpdD | Del  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------| SatU | Left | Down | Right| HueU | Bspc |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |Shift | Undo |  Cut | Copy | Paste|      |-------|    |-------| SatD |      |      |      | HueD |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[2] = LAYOUT(
  _______, UG_VALD, UG_VALU, UG_SPDD, UG_SPDU, UG_TOGG,                          RM_VALU, _______, RM_NEXT, _______,  RM_SPDU, RM_TOGG,
  _______, KC_INS,  KC_PSCR, KC_APP,  XXXXXXX, XXXXXXX,                          RM_VALD, KC_PGDN, KC_UP,   KC_PGUP,  RM_SPDD, KC_DEL,
  _______, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, KC_CAPS,                          RM_SATU, KC_LEFT, KC_DOWN, KC_RGHT,  RM_HUEU, KC_BSPC,
  _______, KC_UNDO, KC_CUT, KC_COPY, KC_PASTE, XXXXXXX,  _______,       _______, RM_SATD, _______, _______, _______,  RM_HUED, KC_RSFT,
                     _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
)
};
